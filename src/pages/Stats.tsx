    ...
    <AppShell title={t("stats.title")}>
      <div className="progress-container">
        ...
        <div className="progress-layout">
          ...
          <section className="progress-panel glass-panel"><div className="panel-heading"><div><span className="eyebrow">{t("stats.futurePath")}</span><h2>{t("stats.grammarProgress")}</h2></div></div><div className="panel-placeholder"><span className="coming-soon-mark">文</span><span>{t("stats.grammarComingSoon")}</span></div></section>
